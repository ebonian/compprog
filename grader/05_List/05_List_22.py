...
# loop sorted ids and grades
for a, b in sorted(zip(student_ids, student_grades)):
  sorted_student_ids.append(a)
  sorted_student_grades.append(b)

student_ids = sorted_student_ids
